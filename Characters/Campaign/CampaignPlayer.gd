...
@onready var fp_animator : AnimationPlayer = $AimHelper/FirstPersonAnims/FPAnimator
@onready var fp_weapon : Node3D = $AimHelper/FirstPersonAnims/FPWeapons/Slapper
